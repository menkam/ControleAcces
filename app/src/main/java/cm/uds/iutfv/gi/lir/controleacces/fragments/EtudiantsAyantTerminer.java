...
public class EtudiantsAyantTerminer extends Fragment{
    ...
    public   View  onCreateView (LayoutInflater  inflater ,   ViewGroup  container ,   Bundle  savedInstanceState )   {
        ...
        View v = inflater.inflate(R.layout.fragment_etutiant_ayant_terminer, null);


        //RECYCLERVIEW
        RecyclerView rv = (RecyclerView) v.findViewById(R.id.mRecyclerEtudiantAyantTerminer);
    ...
    public String toString(){
        return "Etudiants Ayant Terminer";
    }
    ...
    /**
     * OBTENIR LA LISTE DES ETUDIANTS AYANT TERMINER
     * @return
     */
        ...
        try {
            ...
            Thread t = new Thread() {
                public void run() {
                    ...
                    HttpGet httpGet = new HttpGet("http://192.168.8.103:8000/androidGetListEtudiant?idActivite=1&statut=1");
                    try{
