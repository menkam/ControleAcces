...
public class RecyclerListeEtudiantFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerViewMaterialAdapter(new PagerAdapter(Session.movies4));
        mRecyclerView.setAdapter(mAdapter);
        //notifier le MaterialViewPager qu'on va utiliser une RecyclerView
        MaterialViewPagerHelper.registerRecyclerView(getActivity(), mRecyclerView, null);*/

        GetListEtudiantAsynctask asynctask = new GetListEtudiantAsynctask();
        String url = Session.getRoute_get_listeEtud();
        asynctask.execute(new String[]{url});

    }

    public class GetListEtudiantAsynctask extends AsyncTask<String, Void, JSONObject> {
                    ...
                    try{
                        ...
                        if(statusCode == 200){
                            ...
                            if(array.length()>0){
                                ...
                                Toast.makeText(context, "pas d'etudiant pour cette matière", Toast.LENGTH_LONG).show();
                            }
