...
public class RecyclerEtudiantTerminerFragment extends Fragment {

    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;
    private int tab = -1;

    public RecyclerEtudiantTerminerFragment(int tab) {
        Session.setTabEnCours(tab);
        this.tab = tab;
    }

    public static RecyclerEtudiantTerminerFragment newInstance(int tab) {
        return new RecyclerEtudiantTerminerFragment(tab);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        GetListEtudiantATAsynctask asynctask = new GetListEtudiantATAsynctask();
    ...
    public class GetListEtudiantATAsynctask extends AsyncTask<String, Void, JSONObject> {
