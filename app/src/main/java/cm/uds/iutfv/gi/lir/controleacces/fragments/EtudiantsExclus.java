...
public class EtudiantsExclus extends Fragment{
    ...
    public   View  onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState )   {
        ...
        View v = inflater.inflate(R.layout.fragment_etudiant_exclus, null);

        //ArrayList<Movie> liste = getList();

        //RECYCLERVIEW
        RecyclerView rv = (RecyclerView) v.findViewById(R.id.mRecyclerEtudiantsExclus);
